...
Loewe_modded_old = function (response.mat, correction = TRUE, Emin = 0, Emax = NA, 
                         nan.handle = c("L4")) 
{
  if (correction) {
    response.mat <- BaselineCorrectionSD(response.mat, Emin = Emin, 
...
BLISS_modded<- function (response.mat, correction = T, Emin = 0, Emax = NA, 
                         nan.handle = c("LL4", "L4")) 
{
  if (correction) {
    response.mat <- BaselineCorrectionSD(response.mat, Emin = Emin, 
...
HSA_modded <-function (response.mat, correction = T, Emin = 0, Emax = NA, 
                       nan.handle = c("LL4", "L4")) 
{
  if (correction) {
    response.mat <- BaselineCorrectionSD(response.mat, Emin = Emin, 
